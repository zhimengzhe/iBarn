<?php include_once 'head.php'; ?>
    ...
    function page(type) {
        ...
        if (type == -1) {
            href = 'index.php?m=share&a=getMyShare&urlkey=<?php echo $urlkey; ?>&search=<?php echo $search; ?>&curPage=<?php echo max($curPage-1, 1); ?>&order=' + order + '&by=' + by;
        } else if (type == 0) {
            href = 'index.php?m=share&a=getMyShare&urlkey=<?php echo $urlkey; ?>&search=<?php echo $search; ?>&curPage=<?php echo min(max($curPage, 1)+1, $page); ?>&order=' + order + '&by=' + by;
        }
